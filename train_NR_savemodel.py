...
import pickle
import numpy as np
#from data_boot import FaceImageIter
...
def get_symbol(args, arg_params, aux_params):
  ...
  gt_one_hot = mx.sym.one_hot(gt_label, depth=args.num_classes, on_value=1.0, off_value=0.0)
  #cross_entropy = mx.sym.broadcast_mul(gt_one_hot, mx.sym.log(softP))
  cross_entropy = -mx.sym.broadcast_mul(gt_one_hot, mx.sym.log(mx.sym.broadcast_mul(a, softP)))
  softmaxloss = mx.sym.MakeLoss(cross_entropy)
